...
const I18N = {
  th: {
    ...
    "proj.p0": "ระบบจองทรัพยากรในออฟฟิศ (ห้องประชุม โต๊ะ รถ อุปกรณ์) แบบ full-stack — กันการจองชนกัน 100% ด้วยการป้องกัน 2 ชั้น (application + PostgreSQL exclusion constraint) พิสูจน์ด้วย concurrency test, มี JWT auth, RBAC และ Docker",
  ...
  en: {
    ...
    "proj.p0": "Full-stack system for booking shared office resources (rooms, desks, vehicles, equipment) — double-bookings made impossible by a two-layer guard (application check + PostgreSQL exclusion constraint), proven by a concurrency test. With JWT auth, RBAC and Docker.",
